...
const skillCategories = {
  frontend: [
    {
      id: 1,
      name: "TypeScript",
      icon: <SiTypescript className="text-blue-500 text-4xl" />, // TypeScript blue
      description: "TypeScript has been the main programming language at most of the projects I've been involved with.",
    },
    {
      id: 2,
      name: "React",
      icon: <SiReact className="text-blue-400 text-4xl" />, // React blue
      description: "I have experience building dynamic user interfaces using React.",
    },
    {
      id: 3,
      name: "Next.js",
      icon: <SiNextdotjs className="text-gray-800 text-4xl" />, // Next.js default
    ...
    },
    {
      id: 4,
      name: "HTML",
      icon: <SiHtml5 className="text-orange-500 text-4xl" />, // HTML orange
      description: "I have a solid understanding of HTML for structuring web content effectively.",
    },
    {
      id: 5,
      name: "React Native",
      icon: <FaReact className="text-blue-400 text-4xl" />, // React Native blue
  ...
  backend: [
    ...
    },
    {
      id: 11,
      name: "REST API",
      icon: <AiOutlineApi className="text-gray-600 text-4xl" />, // Generic API icon
      description: "I have experience with implementing RESTful APIs, to ensure smoot communication between the client and server.",
    },
    {
      id: 12,
      name: "Ruby on Rails",
      icon: <SiRuby className="text-red-600 text-4xl" />, // Ruby on Rails red
    ...
    },
    {
      id: 13,
      name: "Python",
      icon: <SiPython className="text-blue-400 text-4xl" />, // Python blue
...
export default function SkillsSection() {
  ...
  const handleSkillClick = (skillId: number) => {
    setSelectedSkillId((prevId) => (prevId === skillId ? null : skillId)); // Toggle description visibility
  };
  ...
  <div key={category} className="mt-12">
    ...
    <div className="mt-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 relative">
      {skills.map((skill) => (
        <div
          key={skill.id}
          className="flex flex-col items-center cursor-pointer h-36 relative" // Make each card relative
        ...
        >
          ...
          <div className="mt-2 w-32 text-center z-10">
            {selectedSkillId === skill.id && (
              <motion.div
                className="bg-gray-100 text-gray-500 p-2 rounded-md shadow-sm absolute z-10"
